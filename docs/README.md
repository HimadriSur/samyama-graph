...
- **[CYPHER_COMPATIBILITY.md](./CYPHER_COMPATIBILITY.md)** — openCypher feature matrix vs Neo4j and FalkorDB; supported clauses, functions, remaining gaps. Measured TCK conformance is reported in [BENCHMARKS.md](./BENCHMARKS.md).
